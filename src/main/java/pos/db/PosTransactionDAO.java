...
public class PosTransactionDAO {
    ...
    public static String generateNextInvoiceNo() throws SQLException {
    ...
    public static void insertPhysicalSaleItems(int posTransactionId, List<Map<String, Object>> items) throws SQLException {
        Connection conn = DBConnection.getConnection();
        ...
        for (Map<String, Object> item : items) {
            ...
            // Set online_inventory_item_id and in_store_inventory_item_id
